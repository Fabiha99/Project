...
<?php include_once "../controller/AddTeacher_Check.php" ;?>
<html>
	<head>
		<title>Add Teacher</title>

	</head>
	<body style='background-image: url("Resources/gg.PNG");  background-size: cover; background-repeat: no-repeat;'>
				...
				<table align="center">
					...
					<tr>
	                   ...
	                   <tr>
						<td>Gender: </td>
						<td>
							<input type="radio" name="gender" id="gender1" onBlur="gender_validation();" value="Male"> Male
							<input type="radio" name="gender" id="gender2" onBlur="gender_validation();"value="Female"> Female
							<input type="radio" name="gender" id="gender3" onBlur="gender_validation();"value="Custom"> Custom
